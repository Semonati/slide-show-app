...
export const EDIT_USER_LINK = document.getElementById('edit-link');
export const LIKES_LINK = document.getElementById('like-page-link');
export const LIKES_LINK_CONTAINER = document.getElementById('like-page-link-container');
export const CREATE_PIC_PAGE_LINK = document.getElementById(
  "create-pic-page-link"
);
export const LINK_TO_SINGUP_PAGE = document.getElementById('link-to-signup-page');
...
export const LIKES_PAGE = document.getElementById('likes-page');
export const EDIT_USER_PAGE = document.getElementById('edit-user-page');
export const MORE_INFO_PIC_PAGE = document.getElementById('pic-details-page');
...
export const START_AUTO_SLIDE_CONTAINER = document.getElementById(
	'stsrt-auto-slide-container'
);
export const START_AUTO_SLIDE = document.getElementById(
	'stsrt-auto-slide'
);
export const STOP_AUTO_SLIDE_CONTAINER = document.getElementById(
	'stop-auto-slide-container'
);
export const STOP_AUTO_SLIDE = document.getElementById(
	'stop-auto-slide'
);
...
/***** edit user *****/
export const SUBMIT_BTN_EDIT = document.getElementById('submit-edit-user-btn');
export const CANCEL_BTN_EDIT = document.getElementById('cancel-edit-user-btn');

export const EDIT_USER_BODY = document.getElementById('edit-user-body');

export const FIRST_EDIT_FIELD = document.getElementById(
	'first-name-edit-field'
);
export const FIRST_EDIT_ERROR = document.getElementById(
	'first-name-edit-error-span'
);
export const LAST_EDIT_FIELD = document.getElementById('last-name-edit-field');
export const LAST_EDIT_ERROR = document.getElementById(
	'last-name-edit-error-span'
);
export const STATE_EDIT_FIELD = document.getElementById('state-edit-field');
export const STATE_EDIT_ERROR = document.getElementById(
	'state-edit-error-span'
);
export const COUNTRY_EDIT_FIELD = document.getElementById('country-edit-field');
export const COUNTRY_EDIT_ERROR = document.getElementById(
	'country-edit-error-span'
);
export const CITY_EDIT_FIELD = document.getElementById('city-edit-field');
export const CITY_EDIT_ERROR = document.getElementById('city-edit-error-span');
export const STREET_EDIT_FIELD = document.getElementById('street-edit-field');
export const STREET_EDIT_ERROR = document.getElementById(
	'street-edit-error-span'
);
export const HOUSE_EDIT_FIELD = document.getElementById('house-edit-field');
export const HOUSE_EDIT_ERROR = document.getElementById(
	'house-edit-error-span'
);
export const ZIP_EDIT_FIELD = document.getElementById('zip-edit-field');
export const ZIP_EDIT_ERROR = document.getElementById('zip-edit-error-span');
export const EMAIL_EDIT_FIELD = document.getElementById('email-edit-field');
export const EMAIL_EDIT_ERROR = document.getElementById(
	'email-edit-error-span'
);
export const PHONE_EDIT_FIELD = document.getElementById('phone-edit-field');
export const PHONE_EDIT_ERROR = document.getElementById(
	'phone-edit-error-span'
);
export const PASSWORD_EDIT_FIELD = document.getElementById(
	'password-edit-field'
);
export const PASSWORD_EDIT_ERROR = document.getElementById(
	'password-edit-error-span'
);
export const PASSWORD_RE_ENTER_EDIT_FIELD = document.getElementById(
	'password-reenter-edit-field'
);
export const PASSWORD_RE_ENTER_EDIT_ERROR = document.getElementById(
	'password-reenter-edit-error-span'
);
export const BIZ_EDIT_FIELD = document.getElementById('isBiz-edit-field');


/***** More picture info *****/
export const PIC_INFO = document.getElementById("pic-info");


/***** Likes Page *****/
export const LIKES_BODY = document.getElementById('likes-row');