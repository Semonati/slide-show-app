...
export const onChangePage = page => {
  ...
  MORE_INFO_PIC_PAGE.className = "d-none";
  LIKES_PAGE.className = "d-none";

  if (page === PAGES.HOME) return (HOME_PAGE.className = "d-block");
  if (page === PAGES.LIKES) return (LIKES_PAGE.className = "d-block");
  if (page === PAGES.MORE_INFO_PIC) return (MORE_INFO_PIC_PAGE.className = 'd-block');
